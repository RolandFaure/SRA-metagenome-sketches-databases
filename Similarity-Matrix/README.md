...
For example, from inside the `test` folder, to create and store vectors from the FracMinHash signature files inside the `toy/` folder to a new folder (`my_toy_db/`):
